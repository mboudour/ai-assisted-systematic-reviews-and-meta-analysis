...
The anonymous review artifact contains compact derived inputs, analysis scripts, figure-generation code, declared dependencies, and automated tests. In particular, \path{evaluator_verdict_cube.csv} reports case-by-field-type-by-null-status-by-verdict counts without source text, allowing the evaluator totals and null cross-tabulation to be recomputed. It also contains the 200-item screening manifest, all 600 screening outputs reduced to labels, and the screening summary. The principal commands are:
