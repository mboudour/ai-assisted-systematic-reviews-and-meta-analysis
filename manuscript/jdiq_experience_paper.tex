...
The 200 screening records were a deterministic subset of a larger stratified sampling frame. We therefore report the realized sample proportion with identical labels across all three calls and the complete adjacent-transition counts, without treating either as population accuracy.
