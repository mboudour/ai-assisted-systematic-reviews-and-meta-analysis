...
Case 3 may support a narrowly defined log hazard-ratio synthesis for three-component major adverse cardiovascular events. Case 15 may support a narrowly defined adjusted odds-ratio synthesis for childhood acute lower respiratory infection under a specified fuel contrast. Both require full-text verification, effect-measure confirmation, report-to-study linkage, one prespecified estimate per independent study, and explicit handling of dependent estimates.
