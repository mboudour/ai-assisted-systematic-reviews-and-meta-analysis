...
Moses Boudourides --- Conceptualization, Methodology, Software, Formal Analysis, Data Curation, Writing -- Original Draft, Writing -- Review \& Editing, Visualization.

\textbf{Data Availability Statement:}
All 20 extraction CSV files, Python scripts, and figure-generation code are publicly available in the accompanying repository https://github.com/mboudour/ai-assisted-systematic-reviews-and-meta-analysis. The repository contains the full Boolean search queries, extraction schemas, and pipeline outputs for all 20 case studies.
...
{\small
\begin{longtable}{r p{6cm} p{7.5cm}}  % \begin{longtable}{r p{3.2cm} p{8.5cm}}
