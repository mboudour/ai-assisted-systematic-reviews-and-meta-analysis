...
def main() -> None:
    ...
    lines = [
        ...
        *[
        ...
        "",
        "The client requested `temperature=0`, and the endpoint accepted the parameter, but the "
        "retained responses do not expose the effective decoding configuration. The audit therefore "
        "reports observed same-request repeatability rather than making a claim about nominally "
        "deterministic decoding.",
        "",
        "Exact stability requires all three successful outputs to match after JSON parsing. For "
        "free-text categorical fields, this rule treats wording variants as different and should "
        "not be used as a standalone instability estimate. All-null numeric outputs are trivially "
        "stable. The companion sensitivity analysis separates null states and reports conservative "
        "normalization and lexical-similarity thresholds. None of these measures establishes "
