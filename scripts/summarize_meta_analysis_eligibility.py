...
def main() -> None:
    ...
    lines = [
        ...
        "and dependence handling. Zero cases satisfy that gate from the archived fields alone. This "
        "result is expected because the historical schemas generally did not capture outcome identity, "
        "time point, compatible effect measure, report-to-study linkage, and dependence. It diagnoses "
        "schema insufficiency; it does not demonstrate that every extracted value is invalid.",
        "",
        ...
        "is outside the amended manuscript scope because no externally calibrated error model or "
        "verified analysis-ready case exists.",
        "",
        "## References",
        "",
